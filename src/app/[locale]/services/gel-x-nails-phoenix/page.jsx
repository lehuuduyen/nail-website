...
const PATH = '/services/gel-x-nails-phoenix';

export async function generateMetadata({ params: { locale } }) {
  const t = await getTranslations({ locale, namespace: 'landing.gelx' });
...
export default function GelXNailsPhoenixPage({ params: { locale } }) {
  setRequestLocale(locale);
  const t = useTranslations('landing.gelx');
