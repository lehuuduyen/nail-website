...
const PATH = '/services/gel-nails-phoenix';

export async function generateMetadata({ params: { locale } }) {
  const t = await getTranslations({ locale, namespace: 'landing.gel' });
...
export default function GelNailsPhoenixPage({ params: { locale } }) {
  setRequestLocale(locale);
  const t = useTranslations('landing.gel');
