...
export function generateStaticParams() {
  // Tích locale × category (route nằm dưới [locale]).
  const categories = VALID_CATEGORY_SLUGS.filter((c) => !STATIC_CATEGORY_PAGES.has(c));
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    // Trang chưa dịch: en index, es/vi noindex (self-canonical).
    ...untranslatedMeta(locale, `/services/${category}`),
  };
}
