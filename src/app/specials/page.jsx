...
export const metadata = {
  title: 'Nail Salon Specials & Deals in North Phoenix, AZ 85021 | Nice Nails & Spa',
  description:
    'Current specials & deals at Nice Nails & Spa in North Phoenix, AZ 85021 — affordable pedicures, manicure deals, and seasonal offers. Book online or call (602) 759-9184.',
  alternates: { canonical: '/specials' },
  openGraph: {
    title: 'Specials & Deals — Nice Nails & Spa, North Phoenix AZ',
    description:
      'Affordable pedicure & manicure deals in North Phoenix 85021. See current offers and book online.',
    type: 'website',
  },
};
    ...
    <>
      ...
      <section className="border-b border-rose-gold/15 bg-gradient-to-b from-cream-dark/90 via-cream to-cream px-4 py-14 text-center md:py-16">
        <nav className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-muted">
          ...
          <span className="text-charcoal">Specials</span>
        </nav>
        <h1 className="font-display text-4xl text-ink md:text-5xl">
          Specials &amp; Deals — Nice Nails &amp; Spa, Phoenix 85021
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-sm text-charcoal md:text-base">
          Looking for affordable pedicures or manicure deals in North Phoenix? This is where we post
          our current offers. A great Groupon alternative for nail salon deals in the 85021 area —
          book online or call us to lock in a time.
        </p>
      </section>
      ...
      {promos.length > 0 ? (
        <div className="py-12 md:py-16">
          ...
          {rest.length > 0 && (
            <div className="mx-auto mt-14 max-w-6xl px-4 md:px-6">
              <h2 className="font-display text-2xl text-ink">More offers</h2>
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
          <div className="mx-auto max-w-xl rounded-2xl border border-rose-gold/20 bg-surface p-8 text-center">
            <h2 className="font-display text-2xl text-ink">No active specials right now</h2>
            <p className="mt-3 text-charcoal">
              Check back soon — we post seasonal pedicure and manicure deals here. In the meantime,
      ...
      <div className="mx-auto max-w-6xl px-4 pb-12 md:px-6 md:pb-16">
        <section className="rounded-2xl border border-rose-gold/15 bg-surface/70 p-6 md:p-10">
          <h2 className="font-display text-2xl text-ink">Affordable nail salon deals in North Phoenix</h2>
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-charcoal">
            Nice Nails &amp; Spa is a full-service nail salon in North Phoenix, AZ 85021, offering
            cheap manicure and spa pedicure options without cutting corners on quality or hygiene.
            Whether you searched for an affordable pedicure near me or pedicure deals in Phoenix, our
            specials above show what&apos;s currently running. Walk-ins are welcome and online booking
            is open 24/7.
          </p>
